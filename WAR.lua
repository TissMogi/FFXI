...
function init_gear_sets()
	...
	sets.precast.JA['Tomahawk'] = { ammo = "Throwing Tomahawk",feet = "Agoge Calligae +1", waist ="Chaac Belt" }    --feet = "Agoge Calligae +3"
    ...
    feet="",--legs={ name="Argosy Breeches +1", augments={'STR+12','Attack+25','"Store TP"+6',}},
    feet="Pummeler's Calligae +2",
    neck="Sanctity Necklace",                                   --neck="War. Beads +1",
    waist="Grunfeld Rope",                                      --waist="Fotia belt",
    left_ear="Steelflash Earring",                              --left_ear={ name="Moonshade Earring", augments={'Accuracy+4','TP Bonus +250',}},
    right_ear="Bladeborn Earring",                              --right_ear="Telos Earring",
    left_ring="Raja's Ring",                                    --left_ring="Regal Ring",
	...
	ammo="Knobkierrie",
    head="Agoge Maske +1",                                      --head={ name="Agoge Mask +3", augments={'Enhances "Savagery" effect',}},
    body="Pummeler's Lorica +2",                                --body="Pummeler's Lorica +3",
    hands="Sulevia's Gauntlets +2",
    ...
    legs={ name="Odyssean Cuisses", augments={'Accuracy+28','Weapon skill damage +5%','DEX+10',}},
    feet="Sulevia's Leggings +2",
    neck="Sanctity Necklace",                                   --neck="War. Beads +1",
    waist="Fotia Belt",
