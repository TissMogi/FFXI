...
function init_gear_sets()
	...
	sets.precast.JA['Tomahawk'] = { ammo = "Throwing Tomahawk",feet = "Agoge Calligae +3", waist ="Chaac Belt" }
	...
	ammo="Sapience Orb",
    head="Arke Zuchetto",
    body={ name="Odyss. Chestplate", augments={'"Fast Cast"+3','MND+9',}},
    hands={ name="Leyline Gloves", augments={'Accuracy+12','Mag. Acc.+14','"Mag.Atk.Bns."+15','"Fast Cast"+2',}},
    legs={ name="Eschite Cuisses", augments={'"Mag.Atk.Bns."+25','"Conserve MP"+6','"Fast Cast"+5',}},
    feet={ name="Odyssean Greaves", augments={'"Mag.Atk.Bns."+14','"Fast Cast"+5','AGI+2',}},
    neck="War. Beads +1",
    waist="Flume Belt",
    ...
    right_ring="Moonbeam Ring",
    back={ name="Cichol's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+7','"Dbl.Atk."+10','Damage taken-5%',}},
    }
